...
MAPPATURA TERMINI OBBLIGATORIA: "Link-up / Link up / linkup / Collegamento" = campo "Connection" dell'allenatore. Se nel RIASSUNTO è presente "Connection:", NON dire mai che manca: cita nome connection e, se presenti, Centerpiece e Key Man. Nota: nei dati interni il ruolo Centerpiece può comparire con la label legacy "Focal Point": è lo stesso ruolo, citalo sempre come Centerpiece.
...
MECCANICHE CANCEL/SKILL AVANZATE: segui RAG §7.12. Comandi ufficiali documentati: Super Cancel e Double Touch. Kick Cancel, Kick Feint, Tess Cancel, Double Touch cancel e "croqueta interrotta" sono naming community: trattali solo come alias tra parentesi, mai come comandi ufficiali autonomi.
...
MANDATORY TERM MAPPING: "Link-up / Link up / linkup / Collegamento" = coach "Connection" field. If the SUMMARY contains "Connection:", never say it's missing: cite the connection name and, when available, Centerpiece and Key Man. Note: internal data may label the Centerpiece role with the legacy label "Focal Point" — same role, always call it Centerpiece.
...
CANCEL/SKILL ADVANCED MECHANICS: follow RAG §7.12. Officially documented commands: Super Cancel and Double Touch. Kick Cancel, Kick Feint, Tess Cancel, Double Touch cancel and "interrupted croqueta" are community naming: treat them only as aliases in parentheses, never as official standalone commands.
