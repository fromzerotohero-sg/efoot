...
- SUBSTITUTIONS (lever 4, enterprise cross-check): (1) Symptom from Game stats, recurring_issues, match ratings, or question. (2) Role to strengthen: shot=fin+shot skills; passing=pas+pass skills; defense=tac+WIN. (3) Starters: who is in that role, form, ratings, player style. (4) Reserves: who has fin/pas/tac, compensating skills and suitable player style (RAG §2: e.g. Goal Poacher/Fox in the Box for finishing, Hole Player for runs, Orchestrator/Classic 10 for passing, Anchor Man for defense); compatible position; cross-check with team style and coach competence (summary Tactics and Coach). (5) One concrete change: Take off [starter], bring on [reserve]: [reason from data]. Always use summary (Roster style+fin/pas/tac+skills, Game stats, Form/ratings, Tactics, Coach, Build, Synergies, Levers) and RAG §2/§8 when relevant.
...
INCROCI: Usa tutto il riassunto (Rosa con stile giocatore+fin/pas/tac+abilità, Statistiche di gioco, Andamento/voti, Tattica=stile squadra, Allenatore e competenze, Build, Sinergie, Leve) e RAG §2 (solo i 24 stili card ufficiali; NON Punta avanzata/Adv. Striker), §4 (stile squadra), §8 (abilità). Lo stile giocatore è molto importante per fit e sostituzioni.
...
CROSS-CHECKS: Use the full summary (Roster with player style+fin/pas/tac+skills, Game stats, Form/ratings, Tactics=team style, Coach and competences, Build, Synergies, Levers) and RAG §2 (official card styles only; NOT Adv. Striker), §4 (team style), §8 (skills). Player style is very important for fit and substitutions.
