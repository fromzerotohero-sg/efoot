    ...
    <main data-tour-id="tour-dashboard-intro" className="p-6 max-w-7xl mx-auto">
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(135deg, rgba(28, 21, 10, 0.96), rgba(7, 18, 30, 0.98) 55%, rgba(5, 8, 20, 0.98) 100%)',
          padding: '22px',
          boxShadow: '0 20px 44px rgba(0, 0, 0, 0.35), 0 0 36px rgba(255, 196, 0, 0.10)'
        }}
      >
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'radial-gradient(circle at top right, rgba(255,215,100,0.16), transparent 34%), radial-gradient(circle at bottom left, rgba(0,212,255,0.12), transparent 30%)',
            pointerEvents: 'none'
          }}
        />
        <div style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '18px', flexWrap: 'wrap' }}>
          <div style={{ flex: '1 1 320px', minWidth: 0 }}>
            ...
            <h2 style={{ margin: 0, fontSize: '24px', fontWeight: 800, color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
              <Radio size={20} color="#FFD76A" />
              {t('liveCoachDashboardTitle')}
            </h2>
            <p style={{ margin: '10px 0 0', maxWidth: '720px', color: 'rgba(255,255,255,0.76)', lineHeight: 1.6, fontSize: '14px' }}>
