...
const copy = {
  it: {
    ...
    buildNoProgression: 'Solo le Trending (POTW/OTW) non usano PT: Highlight, Epic e le altre sì.',
  ...
  en: {
    ...
    buildNoProgression: 'Only Trending cards (POTW/OTW) skip PT; Highlight, Epic and others can build.',
  ...
  es: {
    ...
    buildNoProgression: 'Solo las Trending (POTW/OTW) no usan PT: Highlight, Epic y las demás sí.',
