...
const copy = {
  it: {
    ...
    deepAnalysisLoading: 'Preparo l’analisi…',
    deepAnalysisError: 'Analisi non disponibile. Riprova.',
  ...
  en: {
    ...
    deepAnalysisCost: '2 HP',
    deepAnalysisLoading: 'Preparing analysis…',
    deepAnalysisError: 'Analysis unavailable. Retry shortly.',
