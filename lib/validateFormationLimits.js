 ...
 * - Difesa (D): 2-5 giocatori (max 3 DC, max 1 TD, max 1 TS; almeno 1 TD o TS)
...
export function validateFormationLimits(slotPositions) {
  ...
  if (totalDefenders >= 2 && tdInDefense + tsInDefense < 1) {
    errors.push('Difesa: almeno 1 terzino (TD o TS) obbligatorio')
  }
