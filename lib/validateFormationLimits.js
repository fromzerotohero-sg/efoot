...
export function validateFormationLimits(slotPositions) {
  ...
  // Validazione Attacco (1-5 giocatori, max 2 P e max 1 esterno offensivo ESA/EDA)
  ...
  // ESA/EDA in attacco (y < 40) - esterni offensivi
  ...
  if (esaInAttack + edaInAttack > 1) {
    errors.push(`Attacco: massimo 1 esterno offensivo (ESA/EDA) (attualmente: ${esaInAttack + edaInAttack})`)
  }
