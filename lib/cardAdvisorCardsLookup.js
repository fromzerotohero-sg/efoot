...
import { getCardPlayingStylesContract } from './cardAdvisorV6Context.js'

/**
 * Contratto dual playing style v6 della carta (attack/defense; legacy
 * `playing_style` resta lo stile di attacco). Ri-esposto qui perché il lookup
 * catalogo è il punto di lettura della carta: il contratto vive in
 * `source_payload.playing_styles` (sync) o `playing_styles` (dettaglio live),
 * con fallback legacy via getPlayingStylesContract.
 */
export { getCardPlayingStylesContract }
