...
/**
 * Versione inglese (alias) per codice misto.
 */
export const marginalProgressionCost = costoProssimaTacca
export const totalProgressionCostForTicks = costoTotaleTacche
