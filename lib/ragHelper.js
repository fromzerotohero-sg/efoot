...
const SECTION_KEYWORDS = {
  'OBJETIVO': [
    ...
    'objetivo', 'propósito', 'qué hace', 'para qué sirve'
  ],
  ...
  '3. MÓDULOS TÁCTICOS (CONFIGURABLES)': [
    ...
    'módulos tácticos', 'módulo', 'qué módulo', 'cuál módulo', 'formación', 'formación fluida',
  ...
  '4. ESTILOS EQUIPO - Táctica (configurables)': [
    ...
    'bandas', 'presión total', 'overload', 'ataque directo', 'centro y finalización', 'ataque central',
...
const MECCANICHE_TITLE = '7. MECÁNICAS DE JUEGO AVANZADAS'
const MECCANICHE_TITLE_FALLBACK = 'mecánicas de juego avanzadas'
...
export function getRelevantSections(userMessage, maxChars = DEFAULT_MAX_CHARS) {
  ...
  const STILI_TITLE = '2. ESTILOS JUGADOR - Característica carta (FIJOS)'
  return selected
    .map(s => {
