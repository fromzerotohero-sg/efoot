...
- Work from structure, matchup logic, recurring issues, and gameplay tendencies.
...
- Protect = defensive priority.
- Attack = offensive route or tactical trigger.
- Avoid = one mistake that would hurt this setup.
