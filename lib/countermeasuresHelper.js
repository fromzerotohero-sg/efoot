...
${opponentText}${rosterText}${formationText}${tacticalText}${coachText}${attilaMemoryAnalysis}${historyText}${similarFormationAnalysis}${playerPerformanceAnalysis}${tacticalHabitsAnalysis}${patternsText}${userExperienceText}${matchupEngineText}${metaCountermeasures}
