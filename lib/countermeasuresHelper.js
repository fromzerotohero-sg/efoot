...
FOCUS OUTPUT:
- Massimo 3 azioni operative totali tra formation_adjustments + tactical_adjustments + player_suggestions + individual_instructions.
...
/**
 * Rende l'output focalizzato: poche azioni, nessuna categoria riempita per forza.
...
export function focusCountermeasuresOutput(output) {
  ...
  addGroup('player_suggestions', 0)
  addGroup('individual_instructions', 1)
  addGroup('tactical_adjustments', 2)
  addGroup('formation_adjustments', 3)

  selected.sort((a, b) => byPriority(a.item, b.item) || a.weight - b.weight)
  const keep = selected.slice(0, 3)
