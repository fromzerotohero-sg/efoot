...
export const translations = {
  it: {
    ...
    liveCoachBetaBadge: 'Versione beta',
    liveCoachBetaTitle: 'Coach Live Beta',
    liveCoachBetaText: 'Coach Live è in versione beta ed è al momento accessibile solo ai tecnici autorizzati.',
    liveCoachBetaCodePlaceholder: 'Inserisci codice tecnico',
    liveCoachBetaUnlockButton: 'Sblocca Coach Live',
    liveCoachBetaUnlockLoading: 'Verifica codice in corso...',
    liveCoachBetaUnlockError: 'Impossibile sbloccare Coach Live beta.',
    liveCoachBetaUnlocked: 'Coach Live beta sbloccato. Puoi procedere.',
    liveCoachBetaInvalid: 'Codice tecnico non valido.',
    liveCoachBetaEnterError: 'Inserisci il codice tecnico ricevuto.',
    ...
    // Coach Suggestions
    coachSuggestionLabel: 'Il coach ti suggerisce',
    coachSuggestionCriticalTitle: 'Parti dalle Statistiche di gioco',
    coachSuggestionCriticalMessage: 'Le Statistiche di gioco aiutano il coach a capire meglio come giochi. Puoi caricarle anche senza partite salvate.',
    coachSuggestionCriticalMessageWithMatches: 'Hai già partite salvate. Se aggiungi anche le Statistiche di gioco, i consigli diventano molto più precisi.',
    coachSuggestionPostMatchTitle: 'Facciamo il debrief della partita',
    coachSuggestionPostMatchMessage: 'Se ripartiamo da come è andata davvero, il coach può capire meglio cosa tenere e cosa correggere.',
    coachSuggestionFirstTimeTitle: 'Ti consiglio da dove partire',
    coachSuggestionFirstTimeMessage: 'La cosa più utile adesso è caricare le Statistiche di gioco: danno subito al coach una base reale su come giochi.',
    coachSuggestionPalestraTitle: 'Un passaggio utile adesso',
    coachSuggestionPalestraMessage: 'Hai già dati utili. Un breve passaggio in Palestra Coach può trasformarli in indicazioni più concrete per te.',
    coachSuggestionActionSetup: 'Apri statistiche',
    coachSuggestionActionStats: 'Carica statistiche',
    coachSuggestionActionPalestra: 'Vai alla Palestra',
  ...
  en: {
    ...
    liveCoachBetaBadge: 'Beta version',
    liveCoachBetaTitle: 'Live Coach Beta',
    liveCoachBetaText: 'Live Coach is currently in beta and is available only to authorized technical testers.',
    liveCoachBetaCodePlaceholder: 'Enter technical access code',
    liveCoachBetaUnlockButton: 'Unlock Live Coach',
    liveCoachBetaUnlockLoading: 'Checking access code...',
    liveCoachBetaUnlockError: 'Unable to unlock Live Coach beta.',
    liveCoachBetaUnlocked: 'Live Coach beta unlocked. You can continue.',
    liveCoachBetaInvalid: 'Invalid technical access code.',
    liveCoachBetaEnterError: 'Enter the technical access code you received.',
    ...
    // Coach Suggestions
    coachSuggestionLabel: 'Coach suggestion',
    coachSuggestionCriticalTitle: 'Start with your Game Stats',
    coachSuggestionCriticalMessage: 'Game Stats help the coach understand how you actually play. You can upload them even without saved matches.',
    coachSuggestionCriticalMessageWithMatches: 'You already have saved matches. If you add your Game Stats too, the guidance becomes much more precise.',
    coachSuggestionPostMatchTitle: 'Let\'s debrief the match',
    coachSuggestionPostMatchMessage: 'If we start from what really happened, the coach can understand better what to keep and what to correct.',
    coachSuggestionFirstTimeTitle: 'Here is the best place to start',
    coachSuggestionFirstTimeMessage: 'The most useful next step is uploading your Game Stats: they give the coach a real base on how you play.',
    coachSuggestionPalestraTitle: 'A useful next step',
    coachSuggestionPalestraMessage: 'You already have useful data. A short stop in Coach Gym can turn it into more concrete guidance for you.',
    coachSuggestionActionSetup: 'Open stats',
    coachSuggestionActionStats: 'Upload statistics',
    coachSuggestionActionPalestra: 'Go to Gym',
