...
export const translations = {
  ...
  es: {
    ...
    clickToComplete: 'Pulsa "Completar perfil" para añadir los datos que faltan',
    profileComplete: "Perfil completo",
    loadingProfile: "Cargando perfil…",
    profileSectionSaved: "¡guardado correctamente!",
    profileLevelComplete: "Completo",
    profileLevelIntermediate: "Intermedio",
    profileLevelBeginner: "Principiante",
    profileSectionGame: "Perfil de juego",
    profileGroupAnagrafica: "Datos personales",
    profileGroupGameIdentity: "Identidad de juego",
    profileGroupCoachAi: "Coach AI",
    profileSectionNotifications: "Notificaciones",
    profileNotifWeeklyGoals: "Objetivos semanales",
    profileNotifCredits: "Créditos HP",
    profileNotifLeaderboard: "Clasificación",
    profileNotifCoach: "Coach AI",
    profileSectionPreferences: "Preferencias de la app",
    profileSectionAccount: "Cuenta",
    gestioneProfilo: "Gestión del perfil",
    aiKnowledgeProfile: "Perfil",
    daProfilo: "Desde el perfil",
    ...
    selectDivision: "Selecciona división",
    favoriteTeam: "Club favorito",
