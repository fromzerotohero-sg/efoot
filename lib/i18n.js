...
export const translations = {
  it: {
    ...
    dualStyleAttack: "ATT",
    dualStyleDefense: "DIF",
    noSpecialDefenseStyle: "Nessuno stile speciale",
  ...
  en: {
    ...
    dualStyleAttack: "ATT",
    dualStyleDefense: "DEF",
    noSpecialDefenseStyle: "No special style",
  ...
  es: {
    ...
    dualStyleAttack: "ATQ",
    dualStyleDefense: "DEF",
    noSpecialDefenseStyle: "Sin estilo especial",
