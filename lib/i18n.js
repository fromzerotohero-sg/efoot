...
export const translations = {
  it: {
    ...
    loginSuccessCompletingStatus: 'Verifico l\'accesso e preparo rosa, analisi e consigli su misura per te.',
    loginSuccessDoneTitle: 'Sei ufficialmente dentro',
    loginSuccessDoneStatus: 'Tra un attimo sei in dashboard: partite, rosa e il tuo vantaggio competitivo ti aspettano.',
    ...
    loginSuccessFailedStatus: 'Ti riporto al login: controlla email e link, poi riprova.',
    ...
    replaceInStartingXI: 'Metti ${playerName} (${playerRole}) al posto di ${replacePlayerName} (${replacePlayerRole})',
    replaceInStartingXIHint: '${replacePlayerName} va in panchina',
    replaceInStartingXIRoleNote: 'Entra nello slot ${replacePlayerRole} (card ${playerRole}) — non come ${playerRole} in un altro ruolo',
    substitutionIncomplete: 'Sostituisci un titolare con ${playerName}',
    substitutionIncompleteHint: 'Indica chi esce dalla formazione (dati contromisura incompleti)',
    ...
    pwaInstallSubtitle: 'Apri l’app come un’icona sul telefono, senza passare dal browser.',
    pwaInstallBenefit: 'Accesso rapido, schermo intero e stessa esperienza della dashboard.',
    ...
    pwaInstallIosHint: 'Su iPhone usa Safari: Chrome non supporta l’aggiunta alla Home.',
    ...
    setupStatusRosterMissing: 'Carica la tua rosa per iniziare ad avere consigli davvero su misura.',
    setupStatusRosterPartial: 'La rosa c e gia: completala per avere consigli ancora piu coerenti.',
    setupStatusCritical: 'Ci sono ancora alcuni passaggi da completare per avere consigli piu coerenti.',
    setupStatusPartial: 'Ti manca solo qualche dettaglio per rendere i consigli piu precisi.',
    ...
    starterPackEmptyMessage: 'Ora puoi provare subito l’app e testare tutte le funzioni, compreso il coach. Ricorda però che questa non è la tua vera formazione. Per ricevere consigli davvero personalizzati, carica la tua rosa.',
    starterPackPartialMessage: 'Manteniamo i giocatori che hai già inserito e completiamo automaticamente solo quello che manca.',
    ...
    starterPackFillSuccess: 'Abbiamo completato automaticamente ciò che mancava.',
    starterPackImportError: 'Impossibile importare la formazione di test. Riprova tra poco.',
    ...
    nuovaRosaStageEmptyText: 'Clicca uno slot per aprire il catalogo ufficiale. Completa la rosa con meno attrito e mantieni i dati modificabili.',
    nuovaRosaStageEmptyCta: 'Importa starter pack',
    nuovaRosaStageSeededTitle: 'Hai gia una base',
    nuovaRosaStageSeededText: 'Completa gli slot mancanti con il catalogo, poi rifinisci ruoli, riserve e dettagli giocatore.',
    nuovaRosaStageSeededCta: 'Completa i mancanti',
    nuovaRosaStagePartialTitle: 'Rosa in costruzione',
    nuovaRosaStagePartialText: 'Aggiungi i titolari dal campo e poi rifinisci riserve, tattiche e schede giocatore.',
    nuovaRosaStageFormationReadyTitle: 'Formazione pronta',
    nuovaRosaStageFormationReadyText: 'Hai gli undici titolari. Aggiungi coach e tattiche per una lettura piu completa.',
    nuovaRosaStageSystemReadyTitle: 'Sistema pronto',
    nuovaRosaStageSystemReadyText: 'Rosa, formazione e contesto tattico sono allineati.',
    ...
    coachSuggestionCoachMissingMessage: 'Con un coach attivo i consigli seguono meglio il tuo stile squadra. Puoi aggiungerlo adesso oppure farlo più tardi.',
  ...
  en: {
    ...
    loginSuccessCompletingStatus: 'Verifying your access and preparing squad tools, match analysis and tailored advice.',
    loginSuccessDoneTitle: 'You\'re in',
    loginSuccessDoneStatus: 'Heading to your dashboard: matches, squad and your competitive edge are ready.',
    ...
    loginSuccessFailedStatus: 'Taking you back to login — check your email and link, then try again.',
    ...
    replaceInStartingXI: 'Start ${playerName} (${playerRole}) instead of ${replacePlayerName} (${replacePlayerRole})',
    replaceInStartingXIHint: '${replacePlayerName} moves to the bench',
    replaceInStartingXIRoleNote: 'Takes the ${replacePlayerRole} slot (card ${playerRole}) — not as ${playerRole} elsewhere',
    substitutionIncomplete: 'Replace a starter with ${playerName}',
    substitutionIncompleteHint: 'Specify who leaves the lineup (incomplete countermeasure data)',
    ...
    pwaInstallSubtitle: 'Open the app from an icon on your phone, without the browser bar.',
    ...
    pwaInstallStepAndroid3: 'Confirm — the icon will appear on your Home screen',
    pwaInstallIosHint: 'On iPhone use Safari: Chrome does not support Add to Home Screen.',
    ...
    setupStatusRosterMissing: 'Upload your roster to start getting advice that is truly tailored to you.',
    setupStatusRosterPartial: 'Your roster is there: complete it to make the advice more consistent.',
    setupStatusCritical: 'A few setup steps are still missing before the advice becomes fully consistent.',
    setupStatusPartial: 'Only a few details are missing to make the advice more precise.',
    ...
    starterPackEmptyMessage: 'You can now try the app right away and test all its features, including the coach. But remember: this is not your real formation. To receive truly personalized advice, upload your squad.',
    starterPackPartialMessage: 'We will keep the players you already added and automatically complete only what is missing.',
    ...
    starterPackImportError: 'Unable to import the test formation. Please try again shortly.',
    ...
    nuovaRosaStageEmptyText: 'Click a slot to open the official catalog. Complete your roster with less friction while keeping every player editable.',
    nuovaRosaStageEmptyCta: 'Import starter pack',
    nuovaRosaStageSeededTitle: 'You already have a base',
    nuovaRosaStageSeededText: 'Complete missing slots from the catalog, then refine roles, reserves, and player details.',
    nuovaRosaStageSeededCta: 'Complete missing players',
    nuovaRosaStagePartialTitle: 'Roster in progress',
    nuovaRosaStagePartialText: 'Add starters from the field, then refine reserves, tactics, and player cards.',
    nuovaRosaStageFormationReadyTitle: 'Formation ready',
    nuovaRosaStageFormationReadyText: 'You have the starting eleven. Add coach and tactics for a more complete system read.',
    nuovaRosaStageSystemReadyTitle: 'System ready',
    nuovaRosaStageSystemReadyText: 'Your roster, formation, and tactical context are aligned.',
    ...
    coachSuggestionCoachMissingMessage: 'With an active coach, guidance follows your team style better. You can add it now or do it later.',
