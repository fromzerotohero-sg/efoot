...
export const translations = {
  it: {
    ...
    liveCoachSubtitle: 'Carica la foto, poi apri il coach e ricevi consigli immediati durante la partita.',
    liveCoachCommercialIntro: 'Carica prima la foto dell\'avversario per dare piu contesto al coach. Poi apri la sessione e parla normalmente durante la partita per ricevere consigli immediati.',
    ...
    liveCoachPhotoHelper: 'Con la foto i consigli diventano piu precisi. Senza foto il coach funziona comunque, ma con meno contesto.',
    ...
    liveCoachVoiceHelper: 'Apri la sessione e parla normalmente: il coach ti risponde subito con indicazioni pratiche durante la partita.',
    liveCoachVoiceCedar: 'Cedar - pulita e stabile',
    liveCoachVoiceMarin: 'Marin - calda e premium',
    ...
    liveCoachHpHint: '2 HP avvio + 2 HP per ogni minuto extra',
    liveCoachLiveFeed: 'Feed live',
    liveCoachFeedHelper: 'Qui vedrai la tua richiesta e la risposta del coach in tempo reale.',
    liveCoachYou: 'Tu',
  ...
  en: {
    ...
    liveCoachSubtitle: 'Upload the photo, then start the coach and receive immediate guidance during the match.',
    liveCoachCommercialIntro: 'Upload the opponent photo first to give the coach more context. Then start the session and speak naturally during the match to receive immediate suggestions.',
    ...
    liveCoachPhotoHelper: 'With the photo, the suggestions become more precise. Without it, the coach still works, but with less context.',
    ...
    liveCoachVoiceHelper: 'Start the session and speak naturally: the coach answers immediately with practical guidance during the match.',
    liveCoachVoiceCedar: 'Cedar - clean and stable',
    liveCoachVoiceMarin: 'Marin - warm and premium',
    ...
    liveCoachHpHint: '2 HP to start + 2 HP for each extra minute',
    liveCoachLiveFeed: 'Live feed',
    liveCoachFeedHelper: 'Here you will see your request focus and the coach answer in real time.',
    liveCoachYou: 'You',
    liveCoachCoach: 'Coach',
    liveCoachStatHp: 'HP',
