...
export const translations = {
  it: {
    ...
    // Coach Live (AI Proactive)
    coachLiveLabel: 'Coach AI',
    coachLiveCriticalTitle: 'Ho bisogno di dati!',
    coachLiveCriticalMessage: 'Hai giocato 5 partite ma non ho statistiche. Sto spendendo i tuoi Hero Points per consigli generici. Carichiamo i tuoi dati di gioco e usiamo la Palestra?',
    coachLivePostMatchTitle: 'Debriefing time!',
    coachLivePostMatchMessage: 'Partita salvata! Ora vieni in Palestra Coach: raccontami come è andata, cosa hai notato, se hai seguito i consigli. Devo capire se funzionano!',
    coachLiveFirstTimeTitle: 'Iniziamo bene!',
    coachLiveFirstTimeMessage: 'Ciao! Sono il tuo AI Coach. Per dirti qualcosa di utile, devo prima conoscere come giochi. 3 minuti per caricare le tue statistiche?',
    coachLivePalestraTitle: 'Mi manchi!',
    coachLivePalestraMessage: 'Non ci sentiamo da una settimana nella Palestra. Senza il tuo feedback, i consigli si stanno sgretolando. Dai, un debriefing veloce?',
    coachLiveActionSetup: 'Iniziamo',
    coachLiveActionStats: 'Carica statistiche',
    coachLiveActionPalestra: 'Vai alla Palestra',
    coachLiveLater: 'Più tardi',
  },
  en: {
    // Sidebar
    guide: 'Guide',
    ...
    // Coach Live (AI Proactive)
    coachLiveLabel: 'Coach AI',
    coachLiveCriticalTitle: 'I need data!',
    coachLiveCriticalMessage: 'You\'ve played 5 matches but I have no statistics. I\'m spending your Hero Points on generic advice. Shall we upload your game data and use the Gym?',
    coachLivePostMatchTitle: 'Debriefing time!',
    coachLivePostMatchMessage: 'Match saved! Now come to Coach Gym: tell me how it went, what you noticed, if you followed the advice. I need to know if they work!',
    coachLiveFirstTimeTitle: 'Let\'s start right!',
    coachLiveFirstTimeMessage: 'Hi! I\'m your AI Coach. To tell you something useful, I first need to know how you play. 3 minutes to upload your statistics?',
    coachLivePalestraTitle: 'Missing you!',
    coachLivePalestraMessage: 'We haven\'t spoken in the Gym for a week. Without your feedback, my advice is crumbling. Come on, a quick debriefing?',
    coachLiveActionSetup: 'Let\'s start',
    coachLiveActionStats: 'Upload statistics',
    coachLiveActionPalestra: 'Go to Gym',
    coachLiveLater: 'Later',
  }
}
