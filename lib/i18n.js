...
export const translations = {
  it: {
    ...
    // Coach Suggestions (AI Proactive)
    coachSuggestionLabel: 'Coach AI',
    coachSuggestionCriticalTitle: 'Ho bisogno di dati!',
    coachSuggestionCriticalMessage: 'Hai giocato 5 partite ma non ho statistiche. Sto spendendo i tuoi Hero Points per consigli generici. Carichiamo i tuoi dati di gioco e usiamo la Palestra?',
    coachSuggestionPostMatchTitle: 'Debriefing time!',
    coachSuggestionPostMatchMessage: 'Partita salvata! Ora vieni in Palestra Coach: raccontami come è andata, cosa hai notato, se hai seguito i consigli. Devo capire se funzionano!',
    coachSuggestionFirstTimeTitle: 'Iniziamo bene!',
    coachSuggestionFirstTimeMessage: 'Ciao! Sono il tuo AI Coach. Per dirti qualcosa di utile, devo prima conoscere come giochi. 3 minuti per caricare le tue statistiche?',
    coachSuggestionPalestraTitle: 'Mi manchi!',
    coachSuggestionPalestraMessage: 'Non ci sentiamo da una settimana nella Palestra. Senza il tuo feedback, i consigli si stanno sgretolando. Dai, un debriefing veloce?',
    coachSuggestionActionSetup: 'Iniziamo',
  ...
  en: {
    ...
    // Coach Suggestions (AI Proactive)
    coachSuggestionLabel: 'Coach AI',
    coachSuggestionCriticalTitle: 'I need data!',
    coachSuggestionCriticalMessage: 'You\'ve played 5 matches but I have no statistics. I\'m spending your Hero Points on generic advice. Shall we upload your game data and use the Gym?',
    coachSuggestionPostMatchTitle: 'Debriefing time!',
    coachSuggestionPostMatchMessage: 'Match saved! Now come to Coach Gym: tell me how it went, what you noticed, if you followed the advice. I need to know if they work!',
    coachSuggestionFirstTimeTitle: 'Let\'s start right!',
    coachSuggestionFirstTimeMessage: 'Hi! I\'m your AI Coach. To tell you something useful, I first need to know how you play. 3 minutes to upload your statistics?',
    coachSuggestionPalestraTitle: 'Missing you!',
    coachSuggestionPalestraMessage: 'We haven\'t spoken in the Gym for a week. Without your feedback, my advice is crumbling. Come on, a quick debriefing?',
    coachSuggestionActionSetup: 'Let\'s start',
