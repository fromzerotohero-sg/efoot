...
export const translations = {
  it: {
    ...
    replaceInStartingXIRoleNote:
      "Entra nello slot ${replacePlayerRole} (card ${playerRole}) — non come ${playerRole} in un altro ruolo",
  ...
  en: {
    ...
    replaceInStartingXIRoleNote:
      "Takes the ${replacePlayerRole} slot (card ${playerRole}) — not as ${playerRole} elsewhere",
...
export function useTranslation() {
  ...
  const lang =
    context.lang === "en" || context.lang === "it" ? context.lang : "it";
  return {
    t: context.t,
    lang,
