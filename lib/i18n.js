...
export const translations = {
  it: {
    ...
    importFormation2dOptional: 'Importa formazione da foto 2D (opzionale)',
    importFormation2dHint: 'Carica uno screenshot della disposizione in campo: precompilo il modulo, poi continui con le foto dati standard.',
    importFormation2dExtract: 'Leggi formazione 2D',
    importFormation2dExtracting: 'Lettura formazione 2D...',
    importFormation2dSuccess: 'Precompilazione formazione completata.',
    importFormation2dDetected: 'Modulo rilevato',
    importFormation2dPlayersDetected: 'Giocatori rilevati',
  ...
  en: {
    ...
    importFormation2dOptional: 'Import formation from 2D screenshot (optional)',
    importFormation2dHint: 'Upload a field layout screenshot: we prefill the formation, then you continue with the standard data screenshots.',
    importFormation2dExtract: 'Read 2D formation',
    importFormation2dExtracting: 'Reading 2D formation...',
    importFormation2dSuccess: 'Formation prefill completed.',
    importFormation2dDetected: 'Detected shape',
    importFormation2dPlayersDetected: 'Detected players',
    // Match Wizard Actions
