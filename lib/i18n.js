...
export const translations = {
  it: {
    ...
    replaceInStartingXIRoleNote: 'Non schierare ${playerName} come ${replacePlayerRole}: entra come ${playerRole}',
  ...
  en: {
    ...
    replaceInStartingXIRoleNote: 'Do not play ${playerName} as ${replacePlayerRole} — they enter as ${playerRole}',
