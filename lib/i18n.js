...
export const translations = {
  it: {
    ...
    formationStep1Desc: 'Per ogni giocatore carica 3 foto: carta giocatore (foto profilo), statistiche (numeri abilità) e abilità/booster (skill speciali). Più foto carichi → AI più precisa.',
  ...
  en: {
    ...
    formationStep1Desc: 'For each player upload 3 photos: player card (profile photo), stats (ability numbers) and skills/booster (special skills). More photos you upload → more accurate AI.',
