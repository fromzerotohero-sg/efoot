...
export const translations = {
  it: {
    ...
    profileNotifDailySpin: "Spin giornaliero",
    ...
    profileNotifPushPhone: "Notifiche push sul telefono",
    profileComingSoon: "in arrivo",
    profileSectionPreferences: "Preferenze app",
    profileSectionAccount: "Account",
    profileManageAccount: "Gestisci account MetalGate",
    profileSupport: "Supporto",
    profileBuyHp: "Compra Hero Points",
    profileHpService: "Strumento",
  ...
  en: {
    ...
    profileNotifDailySpin: "Daily spin",
    ...
    profileNotifPushPhone: "Push notifications on your phone",
    profileComingSoon: "coming soon",
    profileSectionPreferences: "App preferences",
    profileSectionAccount: "Account",
    profileManageAccount: "Manage MetalGate account",
    profileSupport: "Support",
    profileBuyHp: "Buy Hero Points",
    profileHpService: "Tool",
