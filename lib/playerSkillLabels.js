...
/** Ordine e nomi inglesi canonici (stesso set usato in nuova rosa / estrazioni); le voci non ufficiali sono marcate legacy in SKILL_DEFINITIONS. */
 ...
 * legacy: true — nome legacy eFHUB / community, NON abilità ufficiale eFootball:
 *   mantenuto solo per risolvere dati già salvati; mai suggerirlo come Skill Training.
 */
const SKILL_DEFINITIONS = [
  { en: 'Double Touch', it: 'Doppio tocco', camel: ['doubleTouch'] },
  { en: 'Tap Trick', it: 'Tap Trick', camel: ['tapTrick'], aliasIt: ['Tap Trik'], aliasEn: ['Tap-Trick'], kind: 'premium' },
  ...
  { en: 'Scissors Feint', it: 'Finta doppio passo', camel: ['scissorsFeint'], aliasIt: ['Doppio passo'] },
  {
    ...
    it: 'Controllo abilità con suola',
  ...
  { en: 'Heading', it: 'Colpo di testa', camel: ['heading'] },
  {
    ...
    aliasIt: ['Tiro a giro da lontano'],
  ...
  { en: 'Power Shot', it: 'Tiro potente', camel: ['powerShot'], aliasIt: ['Tiro Potente'], legacy: true },
  {
    en: 'Knuckle Shot',
    it: 'Tiro di collo',
    camel: ['knuckleShot'],
  ...
  {
    en: 'Long Lofted Pass',
    // legacy eFHUB: abilità inesistente in eFootball — quella reale è Low Lofted Pass (Passaggio a scavalcare).
    // Etichetta tenuta distinta da "Passaggio a scavalcare" per non collidere con Low Lofted Pass.
  ...
  { en: 'Shielding', it: 'Protezione', camel: ['shielding', 'protectTheBall'], legacy: true },
  { en: 'Aggressive Defence', it: 'Contrasto Aggressivo', camel: ['aggressiveDefence', 'aggressiveDefense'], legacy: true },
  { en: 'Anchor', it: 'Anchor (legacy)', camel: ['anchor'], legacy: true },
  { en: 'GK Penalty Saver', it: 'Para-rigori', camel: ['penaltySaver', 'gkPenaltySaver'], aliasEn: ['Penalty Saver', 'Gk Penalty Saver'], aliasIt: ['Para rigori'] },
  { en: 'Set Piece Specialist', it: 'Specialista punizioni', camel: ['setPieceSpecialist', 'deadBallSpecialist'], legacy: true },
  { en: 'Goalkeeper Rush', it: 'Uscita portiere', camel: ['goalkeeperRush', 'gkRush'], legacy: true },
  { en: 'Utility Player', it: 'Jolly', camel: ['utilityPlayer', 'oneManArmy'], legacy: true },
  /**
   ...
   */
  { en: 'Edged Crossing', it: 'Cross spiovente', camel: ['edgedCrossing'], aliasIt: ['Cross tagliente', 'Cross spiombente'], kind: 'premium' },
  { en: 'Phenomenal Pass', it: 'Passaggi illuminanti', camel: ['phenomenalPassing'], aliasIt: ['Passaggio fenomenale', 'Passaggio sensazionale'], aliasEn: ['Phenomenal Passing'], kind: 'premium' },
  { en: 'Phenomenal Finishing', it: 'Istinto del gol', camel: ['phenomenalFinishing'], aliasIt: ['Finalizzazione fenomenale', 'Tiro sensazionale'], kind: 'premium' },
  { en: 'Visionary Pass', it: 'Passaggio calcolato', camel: ['visionaryPass'], aliasIt: ['Passaggio visionario', 'Passaggio illuminante'], kind: 'premium' },
  { en: 'Game-changing Pass', it: 'Passaggi cruciali', camel: ['gameChangingPass'], kind: 'premium' },
  { en: 'Blitz Curler', it: 'Tiro a giro spiovente', camel: ['blitzCurler'], kind: 'premium' },
  { en: 'Bullet Header', it: 'Incornata', camel: ['bulletHeader'], kind: 'premium' },
  { en: 'Aerial Fort', it: 'Difesa svettante', camel: ['aerialFort'], aliasIt: ['Difesa aspettante'], aliasEn: ['Aerial Forte'], kind: 'premium' },
  { en: 'Shadow Hunt', it: 'Pressing alle spalle', camel: ['shadowHunt'], aliasIt: ['Caccia all\'ombra', 'Shadow Hunt'], kind: 'premium' },
  { en: 'Fortress', it: 'Fortezza', camel: ['fortress'], aliasIt: ['Caposaldo'], kind: 'premium' },
  { en: 'Long-reach Tackle', it: 'Tackle in allungo', camel: ['longReachTackle'], aliasIt: ['Contrasto a distanza', 'Taker in a lungo'], aliasEn: ['Long Reach Tackle'], kind: 'premium' },
  { en: 'Incisive Run', it: 'Inserimento incisivo', camel: ['incisiveRun'], kind: 'com_ai' },
  { en: 'Mazing Run', it: 'Corsa ubriacante', camel: ['mazingRun'], kind: 'com_ai' },
  { en: 'Speeding Bullet', it: 'Proiettile veloce', camel: ['speedingBullet'], kind: 'com_ai' },
  { en: 'Long Ball Expert', it: 'Specialista lancio lungo', camel: ['longBallExpert'], aliasEn: ['Long Ball Expert'], kind: 'com_ai' },
  { en: 'Early Crosser', it: 'Cross anticipato', camel: ['earlyCross', 'earlyCrosser'], aliasEn: ['Early Cross'], kind: 'com_ai' },
  { en: 'Long Ranger', it: 'Tiro dalla distanza', camel: ['longRange', 'longRanger'], kind: 'com_ai' },
  { en: 'Low Screamer', it: 'Sassata rasoterra', camel: ['lowScreamer'], aliasIt: ['Rasoterra potente', 'Sasata rasu terra', 'Sassata rasu terra'], kind: 'premium' },
  { en: 'Acceleration Burst', it: 'Scatto bruciante', camel: ['accelerationBurst'], aliasIt: ['Scatto esplosivo'], kind: 'premium' },
  { en: 'Trickster', it: 'Trickster', camel: ['trickster'], kind: 'com_ai' },
  { en: 'Momentum Dribbling', it: 'Dribbling fulmineo', camel: ['momentumDribbling'], aliasIt: ['Dribbling in slancio', 'Dribbling fulminei', 'Dribbling fulmine'], kind: 'premium' },
  { en: 'Magnetic Feet', it: 'Calamita ai piedi', camel: ['magneticFeet'], aliasIt: ['Piedi magnetici', 'Calamita i piedi'], kind: 'premium' },
  { en: 'Cross Specialist', it: 'Specialista cross', camel: ['crossSpecialist'], aliasIt: ['Specialista di cross'], kind: 'playing_style' },
  { en: 'Attack Trigger', it: 'Attivatore d\'attacco', camel: ['attackTrigger'], kind: 'premium' },
  { en: 'Attacking Surge', it: 'Attacking Surge', camel: ['attackingSurge'], aliasIt: ['Sprint in attacco'], kind: 'premium' },
  { en: 'Snap Strike', it: 'Snap Strike', camel: ['snapStrike'], kind: 'premium' },
  { en: 'GK Directing Defence', it: 'Direzione alla difesa', camel: ['gkDirectingDefence', 'gkDirectingDefense'], aliasIt: ['Direzione difesa PT'], aliasEn: ['Gk Direct Defending'], kind: 'premium' },
  { en: 'GK Spirit Roar', it: 'Portiere galvanizzatore', camel: ['gkSpiritRoar'], aliasIt: ['Ruggito spirito PT'], kind: 'premium' },
  { en: 'Willpower', it: 'Forza di volontà', camel: ['willpower'], kind: 'premium' }
]
...
function buildSkillIndex() {
  ...
  for (const row of SKILL_DEFINITIONS) {
    const entry = {
      en: row.en,
      it: row.it,
      kind: row.kind || (row.legacy ? 'legacy' : 'trainable')
    }
...
export function isKnownPlayerSkill(raw) {
  ...
  if (direct) return direct.kind === 'trainable' || direct.kind === 'premium'
  const canon = canonicalSkillStorageName(trimmed)
  if (!canon) return false
  key = normalizeSkillKey(canon)
  const resolved = SKILL_INDEX.get(key)
  return resolved?.kind === 'trainable' || resolved?.kind === 'premium'
}
...
export function getSkillDisplayLabel(raw, lang = 'it') {
  ...
  if (canon && canon !== trimmed) {
    ...
    if (entry2) return lang === 'it' ? entry2.it : entry2.en
  }
  if (lang === 'it') {
...
/** Abilità premium native di specifiche carte, fuori dal normale pool Skill Training. */
