...
const SKILL_DEFINITIONS = [
  ...
  /** Tratti / stili AI efhub (comSkills) — spesso in camelCase nel catalogo e nell'output IA */
  { en: 'Edged Crossing', it: 'Cross tagliente', camel: ['edgedCrossing'] },
  { en: 'Phenomenal Passing', it: 'Passaggio fenomenale', camel: ['phenomenalPassing'] },
  { en: 'Phenomenal Finishing', it: 'Finalizzazione fenomenale', camel: ['phenomenalFinishing'] },
  ...
  { en: 'Acceleration Burst', it: 'Scatto esplosivo', camel: ['accelerationBurst'] },
  { en: 'Trickster', it: 'Trickster', camel: ['trickster'] },
  { en: 'Visionary Pass', it: 'Passaggio visionario', camel: ['visionaryPass'] },
  { en: 'Momentum Dribbling', it: 'Dribbling in slancio', camel: ['momentumDribbling'] },
  { en: 'Magnetic Feet', it: 'Piedi magnetici', camel: ['magneticFeet'] }
]
