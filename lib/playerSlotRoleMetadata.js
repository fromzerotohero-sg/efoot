...
export function buildSlotRoleAugmentsForStarter({ playerRow, slotPosition, metadataBase }) {
  ...
  const hadIntentionalSlotMeta = Boolean(
    existingMeta.intentional_slot_vs_card ||
      ...
      existingMeta.forced_out_of_role ||
      existingMeta.forced_slot_position
  )
...
export function metadataAfterMovingToReserves(mergedMetadata) {
  ...
  const had = Boolean(
    base.intentional_slot_vs_card ||
      base.intentional_slot_position ||
      base.intentional_slot_vs_card_at ||
      base.forced_out_of_role ||
      base.forced_slot_position
  )
  ...
  delete base.forced_out_of_role
  delete base.forced_slot_position
  return base
}
