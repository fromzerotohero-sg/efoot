...
export function formatCoachLinkUpsForHeroPrompt({ coach, starters = [], stylesLookup = {}, lang = 'it' } = {}) {
  ...
  const copy = lang === 'en'
    ? {
      ...
      none: 'COACH LINK-UP PLAYS: none saved. Do NOT treat style competence numbers (e.g. Quick Counter 90) as a Link-up. Do NOT invent Focal Point or Key Man. Say the Link-up is not saved.',
      activatable: 'activatable with current starters',
    ...
    : lang === 'es'
      ? {
        ...
        none: 'LINK-UP DEL ENTRENADOR: ninguno guardado. NO trates los números de competencia de estilo (ej. Contraataque rápido 90) como un Link-up. NO inventes Punto focal ni Hombre clave. Di que el Link-up no está guardado.',
        activatable: 'activable con estos titulares',
      ...
      : {
        ...
        none: 'COLLEGAMENTI ALLENATORE: nessuno salvato. NON trattare i numeri di competenza stile (es. Contropiede veloce 90) come Link-up. NON inventare Punto focale o Uomo chiave. Di\' che il Collegamento non è salvato.',
        activatable: 'attivabile con questi titolari',
  ...
  if (!plays.length) return copy.none
