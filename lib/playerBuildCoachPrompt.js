import { PROGRESSION_KEYS } from '@/lib/efootballBuildRules'
...
const SLIDER_LABELS = {
  ...
  lowerBodyStrength: { it: 'Forza arti inf.', en: 'Lower body', es: 'Fuerza piernas' },
  aerialStrength: { it: 'Forza aerea', en: 'Aerial', es: 'Fuerza aérea' },
