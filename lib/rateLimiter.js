...
export const RATE_LIMIT_CONFIG = {
  ...
  '/api/hero-chat': {
    maxRequests: 60, // Persistenza leggera: messaggi e caricamento thread
    windowMs: 60000
  },
  '/api/hero-chat/plans': {
    maxRequests: 20, // Preview/apply/dismiss di piani
    windowMs: 60000
  },
  '/api/tasks/list': {
  ...
  '/api/refresh-diagnostic': {
    maxRequests: 8, // 8 richieste per minuto (diagnostic pesante; 2 era troppo restrittivo in uso normale)
    windowMs: 60000
  },
  ...
  '/api/live-coach/session': {
    maxRequests: 6,
    windowMs: 60000
  },
  '/api/live-coach/heartbeat': {
    maxRequests: 90,
    windowMs: 60000
  },
  '/api/live-coach/end': {
  ...
  '/api/notifications': {
    maxRequests: 60, // letture frequenti (polling campanella) + mark-read
    windowMs: 60000
  },
