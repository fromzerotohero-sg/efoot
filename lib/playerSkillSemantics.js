...
const SEMANTICS = {
  ...
  taptrick: {
    category: 'dribbling',
    effect: 'Finta rapida manuale che fa esitare il difensore e apre un lato di uscita nel duello.',
    usefulFor: 'Ali, seconde punte, trequartisti e punte tecniche in 1v1 vicino al difensore.',
    caution: 'Non e un boost automatico: evita di forzarla con difensore lontano, senza spazio dopo la finta o con input delay.'
  },
  flipflap: {
    category: 'dribbling',
