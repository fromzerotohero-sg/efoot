...
const SEMANTICS = {
  ...
  risingshot: {
    ...
    caution: 'Su difensori e valore extra, non una soluzione diretta all\'attacco.'
  },
  longrangeshooting: {
    category: 'shooting',
    effect: 'Aumenta precisione dei tiri da fuori area.',
    usefulFor: 'TRQ, CC offensivi, seconde punte e specialisti sui piazzati.',
    caution: 'Se e su un DC, e minaccia da dietro/piazzati: non sostituisce punta o ala.'
  },
  longranger: {
    category: 'shooting',
    ...
    caution: 'Non confondere con lancio/passaggio lungo.'
  },
  lowscreamer: {
    category: 'shooting',
