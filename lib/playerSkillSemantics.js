...
const SEMANTICS = {
  ...
  attackingsurge: {
    category: 'special',
    effect: 'Aumenta l\'esplosività delle corse senza palla del giocatore nella metà campo offensiva quando un compagno è in possesso, aiutandolo ad attaccare più rapidamente lo spazio e la profondità.',
    usefulFor: 'Attaccanti ed esterni che attaccano spazio e profondità senza palla.',
    caution: 'Si attiva automaticamente nelle condizioni previste: non è un aumento permanente di Velocità o Accelerazione e non va confusa con il pack omonimo.'
  },
  supersub: {
    category: 'special',
