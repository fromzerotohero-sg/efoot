...
const SEMANTICS = {
  ...
  taptrick: {
    category: 'dribbling',
    effect: 'Abilita speciale nativa legata a una variante rapida di dribbling.',
    usefulFor: 'Giocatori offensivi tecnici in situazioni di uno contro uno.',
    caution: 'Non e il nome di un comando autonomo documentato: distinguere abilita della carta ed esecuzione manuale.'
  },
  flipflap: {
    category: 'dribbling',
  ...
  longrangeshooting: {
    ...
    caution: 'Non sostituisce punta o ala: su un DC e solo extra su piazzati/seconda palla, non motivo di acquisto o cambio ruolo.'
  },
  longranger: {
    category: 'shooting',
  ...
  anchor: {
    category: 'defending',
    effect: 'Ancoraggio difensivo: stabilizza il reparto e tiene il giocatore nella zona.',
    usefulFor: 'Mediani Collante e DC di copertura.',
    caution: 'Non confondere con Fortezza, che e un tratto condizionale al secondo tempo.'
  },
  fortress: {
    category: 'defending',
    effect: 'Migliora le abilita difensive dal secondo tempo se la squadra e in vantaggio all intervallo.',
    usefulFor: 'Difensori e mediani per proteggere il risultato.',
    caution: 'Situazionale: dipende da vantaggio e secondo tempo. Distinta da Caposaldo.'
  },
  acrobaticclearance: {
    category: 'defending',
  ...
  shadowhunt: {
    category: 'defending',
    effect: 'Su un passaggio alle spalle, aumenta le capacita legate alla velocita durante il recupero.',
    usefulFor: 'MED, TD, TS e DC schierati nelle posizioni previste.',
    caution: 'Abilita speciale automatica della carta; non va confusa con Track Back/Tornante.'
  },
  captaincy: {
    category: 'special',
...
export function getPlayerSkillSemantic(raw) {
  if (!isKnownPlayerSkill(raw)) return null
