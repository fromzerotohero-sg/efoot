...
const ERROR_MAPPINGS = [
  // Crediti insufficienti
  {
    patterns: [
      ...
      'hero points insufficienti',
      'insufficient hero points',
      'not enough credits',
      'recharge',
      'ricarica'
    ],
    message:
      'Hai finito gli Hero Points per questa azione. Ricarica dal pannello usage e riparti subito — nessun errore tecnico.',
    messageEn:
      'You\'ve run out of Hero Points for this action. Top up from your usage dashboard and continue — nothing broke on our side.',
