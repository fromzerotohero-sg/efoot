...
const ROLE_SKILL_PRIORITY = {
  ...
  TD: ['Intercettazione', 'Rientro difensivo', 'Cross calibrato'],
  TS: ['Intercettazione', 'Rientro difensivo', 'Cross calibrato'],
  ...
  ALA: ['Cross calibrato', 'Doppio tocco', 'Rientro difensivo'],
