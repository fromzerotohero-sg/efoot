...
export function mapCatalogRowToBuildCard(row) {
  ...
  return {
    ...
    overall_display: row.overall_display ?? row.overall_level_1 ?? null,
    ...
    ai_playstyles: row.ai_playstyles,
    playing_styles: row.playing_styles || row.source_payload?.playing_styles || null,
