...
/**
 * OVR in campo: baseline → PT (slider salvati) → booster attivo + coach, con cap catalogo.
 */
export function computePlayerFieldOverall({
  ...
  const inGameStats = applyInGameEffects(afterProgression, { player, coach, teamStyle })
