...
const STANDARD_PROGRESSION_LEVEL_CAP_FALLBACK = 30

function catalogShowsProgression(catalogCard) {
  ...
  return Boolean(maxStats && typeof maxStats === 'object' && Object.keys(maxStats).length > 0)
}
