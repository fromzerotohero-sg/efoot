...
export function buildCatalogPlayerSavePayload(card, options = {}) {
  ...
  const comSkills = Array.isArray(payload?.com_skills)
    ? normalizePlayerSkillsArray(payload.com_skills)
    : []
  ...
  return {
    ...
    base_stats:
      payload.base_stats && typeof payload.base_stats === 'object' ? payload.base_stats : {},
    skills,
