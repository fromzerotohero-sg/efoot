 ...
 */
import { getPlayingStylesContract, resolvePlayingStyleDbName, stripPlayingStylePhasePrefix } from '@/lib/playingStyleResolve'
...
export function buildCatalogPlayerSavePayload(card, options = {}) {
  ...
  const rawPlayingStyle =
    stripPlayingStylePhasePrefix(playingStyles.primary) ||
    stripPlayingStylePhasePrefix(payload.role) ||
    stripPlayingStylePhasePrefix(payload.playing_style) ||
    stripPlayingStylePhasePrefix(card.playing_style) ||
    null
