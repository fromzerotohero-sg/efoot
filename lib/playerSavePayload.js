...
export function buildCatalogPlayerSavePayload(card, options = {}) {
  ...
  const attackingStyle = resolvePlayingStyleDbName(
    payload.attacking_playing_style || card?.attacking_playing_style
  )
  const defendingStyle = resolvePlayingStyleDbName(
    payload.defensive_playing_style || card?.defensive_playing_style
  )
