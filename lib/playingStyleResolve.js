...
const PLAYING_STYLE_EN_TO_IT = {
  ...
  'attacking goalkeeper': 'Portiere offensivo',
  ...
  'frontline poacher': 'Rapace in avanti',
  'front line pressure': 'Pressione in attacco',
  'frontline pressure': 'Pressione in attacco',
  ...
  'offensive gk': 'Portiere offensivo',
...
const IT_ALIASES = {
  ...
  'rapace in avanti': 'Rapace in avanti',
  ...
  'front line poacher': 'Rapace in avanti',
  'frontline poacher': 'Rapace in avanti',
  'fulcro dell attacco': "Fulcro dell'attacco",
  'fulcro dellattacco': "Fulcro dell'attacco",
  'difensore instancabile': 'Difensore instancabile',
  'disturbatore di passaggi': 'Disturbatore di passaggi',
  'ruolo di copertura': 'Ruolo di copertura',
  'maestro della difesa alta': 'Maestro della difesa alta',
  'pt offensivo': 'Portiere offensivo',
  'pt difensivo': 'Portiere difensivo',
  'pt stopper': 'PT stopper',
  'portiere stopper': 'PT stopper'
}
...
/**
 * Strip HTML tags left over from PESDB scrape (e.g. `<span style="color: #efefef;">Att:</span> Goal Poacher`).
 ...
 * Also strips HTML wrappers from scraped PESDB cells.
...
export function getPlayerStyleDisplayName(player, stylesLookup = {}) {
  ...
  return player?.role ? stripPlayingStylePhasePrefix(player.role) || '' : ''
}
