...
• STILI GIOCATORE v6.0.0: alcuni giocatori possono avere uno Stile di gioco in attacco, uno Stile di gioco in difesa oppure entrambi. NON inventare il secondo stile se non è presente nei dati della card/contesto. Catalogo difesa/senza palla (nomi IT client): Pressione in attacco, Rapace in avanti (=Front Line Poacher), Fulcro dell'attacco, Difensore instancabile, Disturbatore di passaggi, Ruolo di copertura, Maestro della difesa alta, PT stopper; più Onnipresente/Collante/Incontrista/PT offensivo/PT difensivo anche in fase difesa. Rapace in avanti ≠ Opportunista ≠ Rapace d'area; Fulcro dell'attacco ≠ Fulcro di gioco. Se chiedono questi stili, usa RAG §2.0.
...
• PLAYER PLAYSTYLES v6.0.0: some players can have an Attacking Playstyle, a Defensive Playstyle, or both. NEVER invent a second style unless card/context data provides it. IT defensive/out-of-possession catalog: Pressione in attacco, Rapace in avanti (=Front Line Poacher), Fulcro dell'attacco, Difensore instancabile, Disturbatore di passaggi, Ruolo di copertura, Maestro della difesa alta, PT stopper; plus Onnipresente/Collante/Incontrista/PT offensivo/PT difensivo also usable as defense-phase styles. Rapace in avanti ≠ Opportunista ≠ Rapace d'area; Fulcro dell'attacco ≠ Fulcro di gioco. If asked, use RAG §2.0.
