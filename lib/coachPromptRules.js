...
• STILI GIOCATORE v6.0.0: alcuni giocatori possono avere uno Stile di gioco in attacco, uno Stile di gioco in difesa oppure entrambi. NON inventare il secondo stile se non è presente nei dati della card/contesto. "Pressione in attacco" è un esempio ufficiale di stile difensivo v6; non usarlo come etichetta universale.
...
• PLAYER PLAYSTYLES v6.0.0: some players can have an Attacking Playstyle, a Defensive Playstyle, or both. NEVER invent a second style unless card/context data provides it. "Frontline Pressure" / Italian "Pressione in attacco" is an official v6 defensive-playstyle example, not a universal label.
