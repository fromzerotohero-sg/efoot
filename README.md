...
Utility: Account, Memoria Hero, HP/Wallet, lingua, tornei
```

La nav primaria è Coach · Rosa · Carte. Partite, statistiche, feedback e contromisure sono workflow della chat Hero.
...
| HP | `lib/creditService.js`: `AI_COST = 2`. Wallet MetalGate. |
...
| Operazione | HP |
|------------|----|
| AI standard (chat, palestra, estrazioni, contromisure) | 2 |
