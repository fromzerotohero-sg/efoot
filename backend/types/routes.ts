...
export const ACTIVE_BACKEND_ROUTES = {
  ...
  'hero.feedbackChat': { methods: ['POST'], path: '/v1/coach-feedback/chat', auth: true, credits: 2 },
  'hero.feedbackSave': { methods: ['POST'], path: '/v1/coach-feedback/save', auth: true, credits: 2 },
