const SIDES = Object.freeze(['left', 'center', 'right'])
...
export function toZoneMap(value) {
...
export function averageZoneMaps(maps = []) {
  const sums = { left: 0, center: 0, right: 0 }
